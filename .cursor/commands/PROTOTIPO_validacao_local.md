...
6. Smoke check rápido (opcional): `curl -s -o /dev/null -w "%{http_code}" http://localhost:8080/` → esperado **200**.
...
- Indicar que o **preview** está a correr em **http://localhost:8080/** (ou explicar bloqueio concreto).
